...
## --------------
## the following two functions are used to calculate the inverse of a matrix, if the matrix has been 
## cached before, the inverse of a matrix will be returned right now rather than compute it repeatedly
## --------------
...
## 1. to use these functions, you need first create a invertible matrix p:
##         eg : p <- matrix(c(3,1,1,1,3,1,1,1,3), nrow = 3)
## 2. source this cachematrix.R file to your environment
## 3. type:   cacheSolve (makeCacheMatrix (p))
